...
import br.ufc.great.greattour.streamFiles.StreamVideo;
...
public class VideoActivity extends ListActivity {
	...
	private static String type = "&id_type=3";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        // LOGGER LOG ENTRY
		Logger.addEntry("Displaying Videos");
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String linkVideoOnClicable = ((TextView) view.findViewById(R.id.tvLinkVideo))
						.getText().toString();


				// Starting single contact activity
				Intent in = new Intent(getApplicationContext(),StreamVideo.class);
	...
	private class GetContacts extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			ListAdapter adapter = new SimpleAdapter(
					VideoActivity.this, contactList,
					R.layout.list_item_video, new String[] { TAG_DESCRIPTION, TAG_URL}, new int[] { R.id.tvNameVideos, R.id.tvLinkVideo});
